 ...
 *
 * Provides HTML templates and CSP configuration for documentation Webview.
 * Separated from documentation.ts for better maintainability.
 *
 * Security: nonce-based CSP, XSS protection via strict directives
 */
...
/**
 * Error type for documentation fetch failures
 */
