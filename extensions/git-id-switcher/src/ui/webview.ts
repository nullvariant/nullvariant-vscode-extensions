 ...
 *
 * Provides functions for generating HTML content for VS Code Webview panels.
 * Includes CSP (Content Security Policy) configuration and HTML templates.
 *
 * @internal This module is part of the documentation system.
 */
