/**
 * Workspace Path Validation Module
 *
 * Provides validation functions for VS Code workspace paths and Git submodule paths.
 * Separated from path normalization for single responsibility.
 *
...
import { normalizeAndValidatePath, type NormalizedPathResult } from './normalize';
