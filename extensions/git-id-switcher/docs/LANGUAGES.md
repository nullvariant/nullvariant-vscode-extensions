...
<p align="center">
  <img src="https://assets.nullvariant.com/nullvariant-vscode-extensions/extensions/git-id-switcher/images/whoami.webp" alt="Who am I?" width="600">
</p>
...
- **Minority languages**: Help preserve linguistic diversity
- **Your native language**: Native speakers can significantly improve translation quality

### How to Contribute

1. Fork the repository
2. Create a new directory under `docs/i18n/{language-code}/`
...
### Language Codes
- [ISO 639-1 (2-letter codes)](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
- [ISO 639-2/3 (3-letter codes)](https://en.wikipedia.org/wiki/List_of_ISO_639-2_codes)
