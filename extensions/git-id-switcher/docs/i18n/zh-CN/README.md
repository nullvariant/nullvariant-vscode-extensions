...
Git ID Switcher 支持 VS Code 的[工作区信任](https://code.visualstudio.com/docs/editor/workspace-trust)功能。在不受信任的工作区中，危险操作会被自动限制。
...
1. 打开设置（`Cmd+,` / `Ctrl+,`）
2. 搜索 `gitIdSwitcher.disableWorkspaceTrust`
3. 启用该设置

⚠️ **警告：** 启用此设置会降低安全性。请仅在绝对必要时使用。
