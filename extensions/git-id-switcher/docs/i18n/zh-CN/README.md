...
<table>
  <tr>
    ...
    <td>
      ...
      <br>
      🌐 多语言支持: <a href="../../../README.md">🇺🇸</a> <a href="../ja/README.md">🇯🇵</a> <b>🇨🇳</b> <a href="../zh-TW/README.md">🇹🇼</a> <a href="../ko/README.md">🇰🇷</a> <a href="../de/README.md">🇩🇪</a> <a href="../fr/README.md">🇫🇷</a> <a href="../es/README.md">🇪🇸</a> ... <a href="../../LANGUAGES.md">+20 more</a>
    </td>
  </tr>
</table>
...
打开 VS Code 设置（`Cmd+,` / `Ctrl+,`）→ 搜索 "Git ID Switcher" → 点击 "在 settings.json 中编辑"：
...
```json
{
  "gitIdSwitcher.identities": [
    ...
    },
    {
      ...
      "icon": "🌟",
      "name": "zhangwei-oss",
      "email": "zhangwei.oss@example.com",
      "description": "开源贡献",
