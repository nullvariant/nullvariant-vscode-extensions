...
DIS EXTENSHN RESPEKTZ TEH [WERKSPASE TRUST](https://code.visualstudio.com/docs/editor/workspace-trust) FEECHUR OV VS CODE.

IN **UNTRUSTED WERKSPASEZ**, SUM OPERASHUNZ R RESTRIKTD 2 PROTEKT UR SISTEM:

| OPERASHUN | TRUSTED WERKSPASE | UNTRUSTED WERKSPASE |
|-----------|-------------------|---------------------|
| 🔀 SWICH GIT ID | ✅ CAN HAZ | ⚠️ NEEDZ CONFIRMASHUN |
| 🔑 SWICH SSH KEY | ✅ CAN HAZ | ⚠️ NEEDZ CONFIRMASHUN |
| ⌨️ RUN SSH COMMANDZ | ✅ CAN HAZ | ⚠️ NEEDZ CONFIRMASHUN |
| 📁 MODIFAI GIT CONFIG | ✅ CAN HAZ | ⚠️ NEEDZ CONFIRMASHUN |
| 👁️ VU ID ONLY | ✅ CAN HAZ | ✅ CAN HAZ |

### DISABUL WERKSPASE TRUST CHEK

IF U WANTZ 2 DISABUL CHEK, DO DIS:

1. OPEN VS CODE SETTINGZ
2. SERCH 4 `gitIdSwitcher.security.requireWorkspaceTrust`
3. TURN OFF TEH SETTIN

> ⚠️ **WARNIN**: DISABULIN DIS LEETZ EXTERNAL COMMANDZ RUN WIFOUT TRUST CHEK. ONLY USE IN TRUSTD ENVIRONMNTS PLZ!
