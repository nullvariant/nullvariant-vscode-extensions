...
| Comando                                  | Descrição                               |
| ---------------------------------------- | --------------------------------------- |
| `Git ID Switcher: Select Identity`       | Abrir o seletor de identidade           |
| `Git ID Switcher: Show Current Identity` | Mostrar informações da identidade atual |
