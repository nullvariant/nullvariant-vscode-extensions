...
<table>
  <tr>
    ...
    <td>
      ...
      <br>
      🌐 Idiomas: <a href="../../../README.md">🇺🇸</a> <a href="../ja/README.md">🇯🇵</a> <a href="../zh-CN/README.md">🇨🇳</a> <a href="../zh-TW/README.md">🇹🇼</a> <a href="../ko/README.md">🇰🇷</a> <a href="../de/README.md">🇩🇪</a> <a href="../fr/README.md">🇫🇷</a> <a href="../es/README.md">🇪🇸</a> <b>🇧🇷</b> ... <a href="../../LANGUAGES.md">+20 more</a>
    </td>
  </tr>
</table>
...
<img src="https://raw.githubusercontent.com/nullvariant/nullvariant-vscode-extensions/main/extensions/git-id-switcher/docs/i18n/pt-BR/demo.png" width="600" alt="Demo">
...
Uma configuração típica para gerenciar múltiplas contas GitHub.
...
Abra as configurações do VS Code (`Cmd+,` / `Ctrl+,`) → pesquise "Git ID Switcher" → clique em "Editar em settings.json":
...
```json
{
  "gitIdSwitcher.identities": [
    ...
    },
    {
      ...
      "icon": "🌟",
      "name": "asilva-oss",
      "email": "asilva.oss@example.com",
      "description": "Contribuições open source",
...
| `icon`        |             | Emoji mostrado na barra de status (ex: `"💼"`)              |
